...
CREATE TABLE templates (
  ...
  config_content JSON COMMENT '配置内容JSON(归一化后的openclaw.json)',
  manifest JSON COMMENT '同步清单(Manifest)',
  file_list JSON COMMENT '文件清单(按分类)',
  file_payload JSON COMMENT '物理文件内容(Base64,与config分离存储)',
